...
//import { TeacherModule } from '@modules/core/roles/career-coordinator/career-coordinator.module';

@Global()
@Module({
  imports: [SharedCoreModule, StudentModule, CareerCoordinatorModule],
